// generated by build.php at 2020-09-11 05:36:32

use async_std::sync::Arc;
use core::operator::{http_api, http_server, simple_auth, sql, sql_runner, wasm, Monad, Source};
...
async fn main() {
    ...
    let config6 = serde_json::from_str("{\"wat\":{\"FilePath\":\"/Users/xuzhiqiang/Desktop/workspace/opensource/rust_exp/hi/target/wasm32-unknown-unknown/release/hi.wasm\"}}").unwrap();
