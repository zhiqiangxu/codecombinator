// generated by build.php at 2020-09-08 07:00:59

use async_std::sync::Arc;
use core::operator::{http_api, http_server, sql, sql_runner, Monad, Operator, Source};
...
async fn main() {
    ...
    let mut op0 = Arc::new(sql::Sql::<::sqlx::mysql::MySql>::new(config0).await);
